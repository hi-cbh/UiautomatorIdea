...
import com.uitest.uiautomatorUtil.*;


/**
 * 加载200封邮件，清除缓存，在进入收件箱列表加载
 * 转圈测试
 */
public class testMail extends UiAutomatorTestCase {
	public static void main(String[] args) {
		String jarName = "CopyOfOpenMail";
		String testClass = "com.uitest.testdemo.testMail";
	...
	public void testEmail() throws UiObjectNotFoundException {
		try{
			for (int i = 0; i < 1000000; i++) {
				...
				ADBUtil.adbHome();
				ADBUtil.sleep(5000);
				ElementManager.waitForExistst(By.NAME, "139邮箱", 20).click();
				ADBUtil.sleep(5000);
...
//			adb shell am broadcast -a myemailbroadcast
	...
	public void clear() throws UiObjectNotFoundException{
		...
		ElementManager.waitForExistst(By.ID, "cn.cj.pe:id/message_list_bottom_mine", 20).click();
