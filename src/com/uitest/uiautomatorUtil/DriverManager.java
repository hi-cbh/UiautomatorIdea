...
public class DriverManager{
	...
	public static void swipeToUp() {
		...
		int width = UiDevice.getInstance().getDisplayWidth();
		int height = UiDevice.getInstance().getDisplayHeight();
		UiDevice.getInstance().swipe(width / 2, height  * 4 / 5, width / 2, height / 5, 30);
//		UiautomatorAssistant.UiAutomationLog("swipeToUp");
	 ...
	 * 上滑/2
	 */
	public static void swipeToUp2() {
		System.out.println("drag");
		int width = UiDevice.getInstance().getDisplayWidth();
		int height = UiDevice.getInstance().getDisplayHeight();
		UiDevice.getInstance().swipe(width / 2, height*  2/ 3, width / 2, height / 3, 30);
//		UiautomatorAssistant.UiAutomationLog("swipeToUp");
		System.out.println("[ doing ] swipeToUp ");
	}
