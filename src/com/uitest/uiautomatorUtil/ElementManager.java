...
public class ElementManager extends UiAutomatorTestCase{
	 ...
	 * @return 
	 */
	public static UiObject getUiObjectByinstance(int style, String text, int num){
		UiObject uo = null;
		
		try{
			switch(style){
			case 1:
				uo = new UiObject(new UiSelector().resourceId(text).instance(num));
				break;
			case 2:
				uo = new UiObject(new UiSelector().textContains(text).instance(num));
				break;
			case 3:
				uo = new UiObject(new UiSelector().className(text).instance(num));
				break;
			case 4:
				uo = new UiObject(new UiSelector().descriptionContains(text).instance(num));
				break;
			}
			return uo;
		}catch(Exception e){
